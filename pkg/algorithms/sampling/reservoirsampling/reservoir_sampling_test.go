package reservoirsampling_test

import (
	"fmt"
	"testing"

	"github.com/thanghv97/Coding-Pratice-Algorithms-Go/pkg/algorithms/sampling/reservoirsampling"
)
...
func Test(t *testing.T) {
	...
	sampling := reservoirsampling.Init(data)
	for i := 0; i < 10; i++ {
